...
const urlsToCache = [
  ...
  '/TigerScore/icons/icon.svg',
  '/TigerScore/icons/icon-72x72.png',
  '/TigerScore/icons/icon-96x96.png',
  '/TigerScore/icons/icon-128x128.png',
  '/TigerScore/icons/icon-144x144.png',
  '/TigerScore/icons/icon-152x152.png',
  '/TigerScore/icons/icon-192x192.png',
  '/TigerScore/icons/icon-384x384.png',
  '/TigerScore/icons/icon-512x512.png',
  '/TigerScore/icons/icon-maskable-192x192.png',
  '/TigerScore/icons/icon-maskable-512x512.png',
